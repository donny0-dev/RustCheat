...
bool COverlay::InitWindows(HWND GameHwnd)
{
	...
	static std::string strOverlayClass = "Nice";
	static std::string strOverlayTitle = "Cock";
	...
	m_hWndOverlay = CreateWindowEx(0, strOverlayClass.c_str(), strOverlayTitle.c_str(), WS_POPUP | WS_VISIBLE, static_cast<int>(GameRect.left - 2.f), static_cast<int>(GameRect.top - 2.f), static_cast<int>(m_pWidth + 2.f), static_cast<int>(m_pHeight + 2.f), 0, NULL, NULL, NULL);
	if (!m_hWndOverlay)
		return false;

	static MARGINS DWMMargins = { static_cast<int>(GameRect.left - 2.f), static_cast<int>(GameRect.top - 2.f), static_cast<int>(m_pWidth + 2.f), static_cast<int>(m_pHeight + 2.f) };
