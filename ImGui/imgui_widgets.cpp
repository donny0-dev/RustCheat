...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_anim->second.clicked_transition = ImLerp(it_anim->second.clicked_transition, (pressed ? 0.1f : 0.0f), menu.anim_speed * (1.0f - ImGui::GetIO().DeltaTime));
    ...
    // window->DrawList->AddRect(bb.Min, bb.Max, ImColor(141 / 255.0f, 168 / 255.0f, 241 / 255.0f, menu.m_alpha * it_anim->second.clicked_transition), 2.0f);

    window->DrawList->AddRect(bb.Min, bb.Max, ImColor(1.0f, 1.0f, 1.0f, menu.m_alpha * 0.06f + it_anim->second.hovered_outline), 2.0f);
    window->DrawList->AddRect(bb.Min, bb.Max, ImColor(141 / 255.0f, 168 / 255.0f, 241 / 255.0f, menu.m_alpha * 0.1f + it_anim->second.clicked_transition), 2.0f);
